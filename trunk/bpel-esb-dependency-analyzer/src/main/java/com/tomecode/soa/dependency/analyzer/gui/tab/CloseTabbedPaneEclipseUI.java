 ...
 * 
 */
public final class CloseTabbedPaneEclipseUI extends CloseTabbedPaneUI {
	...
	public static ComponentUI createUI(JComponent c) {
		return new CloseTabbedPaneEclipseUI();
	}
	 ...
	 * 
	 */
	protected final class ScrollableTabButton extends CloseTabbedPaneUI.ScrollableTabbedButton {

		private static final long serialVersionUID = 4433915601374224256L;
