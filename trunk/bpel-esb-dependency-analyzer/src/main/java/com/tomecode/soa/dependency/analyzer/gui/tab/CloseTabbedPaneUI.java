...
public class CloseTabbedPaneUI extends BasicTabbedPaneUI {
	...
	public CloseTabbedPaneUI() {
		super();
		closeImgI = IconFactory.TAB_CLOSE_IMAGE;
	...
	protected void drawButton(BufferedImage img, int w, int h) {
		...
		int xw = w - fudge * 2;
		int yh = h = fudge * 2;
		g.drawLine(fudge, fudge, xw, yh);
		g.drawLine(xw, fudge, fudge, yh);
		g.dispose();
	}
	...
	/**
	 * create new instance of {@link ScrollableTabbedButton}
	 * 
	 * @param direction
	 * @return
	 */
	protected ScrollableTabbedButton createScrollableTabbedButton(int direction) {
		return new ScrollableTabbedButton(direction);
	}
	 ...
	 * 
	 */
	private static final class RightAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class LeftAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class DownAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class PreviousAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class PageUpAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class PageDownAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class RequestFocusAction extends AbstractAction {
	 ...
	 * 
	 */
	private static final class RequestFocusForVisibleAction extends AbstractAction {
	 ...
	 * @author Frastia Tomas
	 */
	private static final class SetSelectedIndexAction extends AbstractAction {
	...
	private static class ScrollTabsForwardAction extends AbstractAction {
		...
		public final void actionPerformed(ActionEvent e) {
			...
			} else if (src instanceof ScrollableTabbedButton) {
				pane = (JTabbedPane) ((ScrollableTabbedButton) src).getParent();
			} else {
	 ...
	 * 
	 */
	private static final class ScrollTabsBackwardAction extends AbstractAction {
			...
			if (selectedIndex < 0) {
				...
				if (numChildren > 0) {
					...
					for (int i = 0; i < numChildren; i++) {
						...
						} else if (child instanceof ScrollableTabbedButton) {
							ScrollableTabbedButton scrollbutton = (ScrollableTabbedButton) child;
	...
	/**
	 * Scrollable tabbed panel support
	 * 
	 * @author Frastia Tomas
	 * 
	 */
	private final class ScrollableTabSupport implements ChangeListener {
		...
		public final ScrollableTabbedButton scrollForwardButton;

		public final ScrollableTabbedButton scrollBackwardButton;
		...
		ScrollableTabSupport(int tabPlacement) {
			...
			scrollForwardButton = createScrollableTabbedButton(EAST);
			scrollBackwardButton = createScrollableTabbedButton(WEST);
	...
	private final class ScrollableTabPanel extends JPanel implements UIResource {
		...
		public final void paintComponent(Graphics g) {
			...
			CloseTabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(), tabPane.getSelectedIndex());
	 ...
	 * 
	 */
	protected class ScrollableTabbedButton extends BasicArrowButton implements UIResource, SwingConstants {
		 ...
		 * @param direction
		 */
		public ScrollableTabbedButton(int direction) {
	...
	private final Vector<View> createHTMLVector() {
	 ...
	 *@author Frastia Tomas
	 */
	final class MyMouseHandler extends MouseHandler {
