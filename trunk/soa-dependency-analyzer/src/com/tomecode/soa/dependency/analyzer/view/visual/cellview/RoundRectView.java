package com.tomecode.soa.dependency.analyzer.view.visual.cellview;
 ...
 * 
 */
public final class RoundRectView extends VertexView {

	private static final long serialVersionUID = 8301914865124391833L;
	 ...
	 * 
	 */
	private final static class ActivityRenderer extends VertexRenderer {

		private static final long serialVersionUID = -8267646918725257884L;
		...
		public void paint(Graphics g) {
			...
			int roundRectArc = RoundRectView.getArcSize(d.width - b, d.height - b);
			if (super.isOpaque()) {
