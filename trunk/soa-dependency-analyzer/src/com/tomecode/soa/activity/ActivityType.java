...
public enum ActivityType {
	...
	ORACLE_10G_SCOPE("scope", ImageFactory.ORACLE_10G_SCOPE), ORACLE_10G_WAIT("wait"), ORACLE_10G_WHILE("while"), ORACLE_10G_SEQUENCE("sequence",
			ImageFactory.ORACLE_10G_SEQUENCE), ASSIGN("assign"), ORACLE_10G_EMPTY("empty"), ORACLE_10G_RECEIVE("receive", null, true), ORACLE_10G_INVOKE("invoke", null, true), ORACLE_10G_REPLY(
"reply", null, true), SWITCH("switch", ImageFactory.ORACLE_10G_SWITCH), ORACLE_10G_CATCH("catch", null, true), CATCHALL("catchAll", ImageFactory.ORACLE_10G_CATCHALL), ORACLE_10G_ONALARM("onAlarm"), ORACLE_10G_ONMESSAGE(
			"onMessage", null, true), ORACLE_10G_COMPENSATIONHANDLER("compensationHandler", ImageFactory.ORACLE_10G_COMPENSATIONHANDLER), ORACLE_10G_JAVA_EMBEDDING("exec",
			ImageFactory.ORACLE_10G_BPELX_EXEC), ORACLE_10G_PICK("pick", ImageFactory.ORACLE_10G_PICK), ORACLE_10G_FLOW("flow", ImageFactory.ORACLE_10G_FLOW), ORACLE_10G_FLOWN("flowN"), ORACLE_10G_COMPENSATE(
			"compensate", ImageFactory.ORACLE_10G_COMPENSTATE), ORACLE_10G_TERMINATE("terminate", ImageFactory.ORACLE_10G_TERMINATE), ORACLE_10G_THROW("throw", null, true), ORACLE_10G_PARTNERLINK(
			"partnerLink"), ORACLE_10G_VARIABLE("variable", ImageFactory.ORACLE_10G_VARIABLE), ORACLE_10G_TRANSFORMATE("transformation", null, true), ORACLE_10G_EMAIL("email"), ORACLE_10G_PAGER(
			"pager", ImageFactory.ORACLE_10G_PAGER), ORACLE_10G_FAX("fax"), ORACLE_10G_SMS("sms"), ORACLE_10G_VOICE("voice"), ORACLE_10G_CASE("case"), ORACLE_10G_OTHERWISE("otherwise"), ORACLE_10G_HUMANTASK(
			"workflow"),
	// ----------OPEN ESB BPEL
	OPEN_ESB_BPEL_SEQUENCE("sequence", ImageFactory.OPEN_ESB_BPEL_SEQUENCE), OPEN_ESB_BPEL_VARIABLE("variable", ImageFactory.OPEN_ESB_BPEL_VARIABLE), OPEN_ESB_BPEL_FAULT_HANLDERS("faultHandlers",
			...
			"rethrow", ImageFactory.OPEN_ESB_BPEL_RETHROW), OPEN_ESB_BPEL_EMPTY("empty"), OPEN_ESB_BPEL_COMPENSATESCOPE("compensateScope", ImageFactory.OPEN_ESB_BPEL_COMPENSATESCOPE), OPEN_ESB_BPEL_COMPENSATE(
			"compensate", ImageFactory.OPEN_ESB_BPEL_COMPENSATE), OPEN_ESB_BPEL_WHILE("while", ImageFactory.OPEN_ESB_BPEL_WHILE), OPEN_ESB_BPEL_ONMESSAGE("onMessage",
			ImageFactory.OPEN_ESB_BPEL_ONMESSAGE), OPEN_ESB_BPEL_FOREACH("forEach", ImageFactory.OPEN_ESB_BPEL_FOREACH), OPEN_ESB_BPEL_REPEAT_UNTIL("repeatUntil",
	...
	private static final ActivityType[] ORA10G_BPEL = new ActivityType[] { ORACLE_10G_SCOPE, ORACLE_10G_WAIT, ORACLE_10G_WHILE, ORACLE_10G_SEQUENCE, ASSIGN, ORACLE_10G_EMPTY, ORACLE_10G_RECEIVE,
			ORACLE_10G_INVOKE, ORACLE_10G_REPLY, SWITCH, ORACLE_10G_CATCH, CATCHALL, ORACLE_10G_ONALARM, ORACLE_10G_ONMESSAGE, ORACLE_10G_COMPENSATIONHANDLER, ORACLE_10G_JAVA_EMBEDDING, ORACLE_10G_PICK,
			ORACLE_10G_FLOW, ORACLE_10G_FLOWN, ORACLE_10G_COMPENSATE, ORACLE_10G_TERMINATE, ORACLE_10G_THROW, ORACLE_10G_PARTNERLINK, ORACLE_10G_VARIABLE, ORACLE_10G_TRANSFORMATE, ORACLE_10G_EMAIL,
			ORACLE_10G_PAGER, ORACLE_10G_FAX, ORACLE_10G_SMS, ORACLE_10G_VOICE, ORACLE_10G_CASE, ORACLE_10G_OTHERWISE, ORACLE_10G_HUMANTASK
