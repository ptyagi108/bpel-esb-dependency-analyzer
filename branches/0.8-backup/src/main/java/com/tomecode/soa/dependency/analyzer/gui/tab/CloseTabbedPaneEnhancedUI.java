 ...
 * 
 */
public final class CloseTabbedPaneEnhancedUI extends CloseTabbedPaneUI {
	...
	private static final Color lightBlue = new Color(0x8CA9FF);// 70, 150, 200,
	// 50);
	...
	public static ComponentUI createUI(JComponent c) {
		return new CloseTabbedPaneEnhancedUI();
	}
	...
	/**
	 * 
	 * @author Frastiat Tomas
	 * 
	 */
	protected class ScrollableTabbedPanelButton extends CloseTabbedPaneUI.ScrollableTabbedButton {
		 ...
		 * @param direction
		 */
		public ScrollableTabbedPanelButton(int direction) {
			super(direction);
	...
	protected CloseTabbedPaneUI.ScrollableTabbedButton createScrollableTabbedButton(int direction) {
		return new ScrollableTabbedPanelButton(direction);
	}
